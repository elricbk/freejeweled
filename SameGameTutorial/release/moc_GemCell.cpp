...
**
** Created: Thu 30. Sep 15:50:40 2010
...
static const uint qt_meta_data_GemCell[] = {
 ...
 // enum data: key, value
     220, uint(GemCell::Normal),
     227, uint(GemCell::Explosive),
     237, uint(GemCell::HyperCube),
     247, uint(GemCell::RowColumnRemove),
...
static const char qt_meta_stringdata_GemCell[] = {
    ...
    "explodedOnce\0Modifier\0modifier\0Normal\0"
    "Explosive\0HyperCube\0RowColumnRemove\0"
};
...
int GemCell::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: *reinterpret_cast< Modifier*>(_v) = modifier(); break;
        }
        _id -= 5;
        ...
        case 4: setModifier(*reinterpret_cast< Modifier*>(_v)); break;
        }
        _id -= 5;
